...
template <typename _T>
__vec_iterator<_T>::__vec_iterator(__vec_iterator<_T>::pointer __p)
    : __ptr__(__p) {}

template <typename _T>
__vec_iterator<_T>::__vec_iterator(const __vec_iterator<_T>& __i)
    : __ptr__(__i.__ptr__) {}

template <typename _T>
template <typename _U, typename>
__vec_iterator<_T>::__vec_iterator(const __vec_iterator<_U>& __i)
    : __ptr__(const_cast<pointer>(__i.__ptr__)) {}
...
template <typename _T>
typename __vec_iterator<_T>::difference_type __vec_iterator<_T>::operator-(
    __vec_iterator& __i) {
