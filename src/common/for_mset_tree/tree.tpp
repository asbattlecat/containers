...
template <typename _T, class _Compare, class _Allocator>
__tree<_T, _Compare, _Allocator>& __tree<_T, _Compare, _Allocator>::operator=(
    __tree&& __oth) {
  if (this != &__oth) {
    this->clear();
    ...
    std::swap(this->node_alloc_, __oth.node_alloc_);
...
template <typename _T, class _Compare, class _Allocator>
void __tree<_T, _Compare, _Allocator>::erase(iterator __pos) {
...
template <typename _T, class _Compare, class _Allocator>
typename __tree<_T, _Compare, _Allocator>::iterator
__tree<_T, _Compare, _Allocator>::lower_bound(const_reference __ref) {
  node_pointer __n = this->root_;
...
template <typename _T, class _Compare, class _Allocator>
typename __tree<_T, _Compare, _Allocator>::iterator
__tree<_T, _Compare, _Allocator>::upper_bound(const_reference __ref) {
  node_pointer __n = this->root_;
  node_pointer __res = nullptr;
...
template <typename _T, class _Compare, class _Allocator>
void __tree<_T, _Compare, _Allocator>::replace(iterator l, iterator r) {
...
__tree<_T, _Compare, _Allocator>::count(const_reference __ref) {
  ...
  if (__lb != this->end() && *__lb == __ref) {
    iterator __ub = this->upper_bound(__ref);
    while (__ub != __lb) {
      __lb++;
      __count++;
    }
...
template <typename _T, class _Compare, class _Allocator>
void __tree<_T, _Compare, _Allocator>::clear() {
...
template <typename _T, class _Compare, class _Allocator>
void __tree<_T, _Compare, _Allocator>::display() {
  this->_display_node(this->root_);
}

template <typename _T, class _Compare, class _Allocator>
void __tree<_T, _Compare, _Allocator>::_copy(const __tree& oth) {
  if (this != &oth) {
...
template <typename _T, class _Compare, class _Allocator>
void __tree<_T, _Compare, _Allocator>::_copy(node_pointer* __src,
                                             node_pointer __dst,
...
template <typename _T, class _Compare, class _Allocator>
void __tree<_T, _Compare, _Allocator>::_display_node(node_pointer node,
...
void __tree<_T, _Compare, _Allocator>::_construct(_InputIter __f,
                                                  _InputIter __l) {
  while (__f != __l) {
    this->insert(*__f);
    __f++;
  ...
  if (__n->right_ == nullptr && __n->left_ == nullptr) {
    ...
    if (__n->right_ && __n->right_ != this->sentinel_) {
      ...
      if (__n->left_) {
        ...
        while (__replaced != nullptr && __replaced->right_ != nullptr)
          __replaced = __replaced->right_;
      } else {
...
template <typename _T, class _Compare, class _Allocator>
void __tree<_T, _Compare, _Allocator>::_replace_nodes(node_pointer __lhs,
                                                      node_pointer __rhs) {
  if (__lhs == __rhs) {
    return;
  }
  ...
  if (__lhs->parent_ == __rhs || __rhs->parent_ == __lhs) {
    ...
    node_type __lhs_parent =
        __lhs->parent_ != nullptr ? *(__lhs->parent_) : node_type();
    node_type __rhs_parent =
        __rhs->parent_ != nullptr ? *(__rhs->parent_) : node_type();
...
template <typename _T, class _Compare, class _Allocator>
int __tree<_T, _Compare, _Allocator>::_distance_between(node_pointer __lhs,
                                                        node_pointer __rhs) {
  if (__lhs == __rhs) {
    return 0;
  } else {
    ...
    return this->_depth_from_root(_lca, __lhs) +
           this->_depth_from_root(_lca, __rhs);
  }
}

template <typename _T, class _Compare, class _Allocator>
int __tree<_T, _Compare, _Allocator>::_depth_from_root(node_pointer __root,
                                                       node_pointer __n,
                                                       int __depth) {
  if (__root == nullptr) {
    return -1;
...
template <typename _T, class _Compare, class _Allocator>
typename __tree<_T, _Compare, _Allocator>::node_pointer
__tree<_T, _Compare, _Allocator>::_find_lca(node_pointer __root,
                                            node_pointer __lhs,
                                            node_pointer __rhs) {
...
template <typename _T, class _Compare, class _Allocator>
void __tree<_T, _Compare, _Allocator>::_clear_node(node_pointer __n) {
  if (__n != nullptr) {
...
template <typename _T, class _Compare, class _Allocator>
typename __tree<_T, _Compare, _Allocator>::node_pointer
__tree<_T, _Compare, _Allocator>::_insert_node(node_pointer __n,
...
template <typename _T, class _Compare, class _Allocator>
typename __tree<_T, _Compare, _Allocator>::node_pointer
__tree<_T, _Compare, _Allocator>::_find_node(const_reference __ref,
                                             _Compare comp) {
  node_pointer __n = this->root_;
...
template <typename _T, class _Compare, class _Allocator>
typename __tree<_T, _Compare, _Allocator>::node_pointer
__tree<_T, _Compare, _Allocator>::_create_node(const_reference __ref,
                                               node_pointer __parent) {
...
template <typename _T, class _Compare, class _Allocator>
void __tree<_T, _Compare, _Allocator>::_destroy_node(node_pointer __n) {
