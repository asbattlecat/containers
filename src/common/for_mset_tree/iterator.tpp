...
template <typename _T>
__tree_iterator<_T>::__tree_iterator(const __tree_iterator &__it)
    : n_(__it.n_) {}

template <typename _T>
template <typename _R>
__tree_iterator<_T>::__tree_iterator(const __tree_iterator<_R> &__it)
    : n_(reinterpret_cast<__node<value_type> *>(__it.n_)) {}
...
template <typename _T>
typename __tree_iterator<_T>::template __node<
    typename __tree_iterator<_T>::value_type> *
__tree_iterator<_T>::get() {
  return this->n_;
}
