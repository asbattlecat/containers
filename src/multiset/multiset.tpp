...
template <typename _T, class _Compare, class _Allocator>
bool multiset<_T, _Compare, _Allocator>::empty() {
...
template <typename _T, class _Compare, class _Allocator>
void multiset<_T, _Compare, _Allocator>::clear() {
  this->tree_.clear();
}
...
multiset<_T, _Compare, _Allocator>::insert_many(Args &&...args) {
  static_assert((std::is_convertible<Args, _T>::value && ...),
                "multiset insert_many must be convertible to value_type");
...
template <typename _T, class _Compare, class _Allocator>
void multiset<_T, _Compare, _Allocator>::erase(iterator __pos) {
  if (this->empty()) {
...
template <typename _T, class _Compare, class _Allocator>
void multiset<_T, _Compare, _Allocator>::erase(iterator __f, iterator __l) {
  if (this->empty()) {
    throw std::out_of_range("s21:: multiset erase empty");
  }
...
template <typename _T, class _Compare, class _Allocator>
void multiset<_T, _Compare, _Allocator>::erase(const_reference __ref) {
...
template <typename _T, class _Compare, class _Allocator>
void multiset<_T, _Compare, _Allocator>::swap(multiset &__oth) {
  if (this != &__oth) {
...
template <typename _T, class _Compare, class _Allocator>
void multiset<_T, _Compare, _Allocator>::merge(multiset &__oth) {
  if (this != &__oth) {
...
template <typename _T, class _Compare, class _Allocator>
bool multiset<_T, _Compare, _Allocator>::contains(const_reference __ref) {
  return this->tree_.find(__ref) != this->tree_.end();
}

template <typename _T, class _Compare, class _Allocator>
std::pair<typename multiset<_T, _Compare, _Allocator>::iterator,
          typename multiset<_T, _Compare, _Allocator>::iterator>
multiset<_T, _Compare, _Allocator>::equal_range(const_reference ref) {
  if (this->find(ref) != this->end()) {
    iterator it = this->lower_bound(ref);
    iterator jt = this->upper_bound(ref);
